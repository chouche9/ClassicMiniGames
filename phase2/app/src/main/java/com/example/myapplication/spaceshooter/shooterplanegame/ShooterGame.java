...
public class ShooterGame extends AppCompatActivity
    implements BonusLevelDialog.BonusLevelDialogListener, ShooterGameInterface {
  /** The Game view. */
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ShooterPlaneGameLogic shooterPlaneGameLogic =
        new ShooterPlaneGameLogic(shooterGameStatus, this, gameView);
  ...
  public void bonusLevelResult(boolean isWon, int bonusScore) {
    shooterGamePresenter.handleBonusGameResult(isWon, bonusScore);
    onCancel();
  }
