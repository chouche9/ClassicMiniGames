...
public class ShooterPointBuff extends ShooterSpecialItem {
  /**
   * Instantiates a new Shooter point buff. that increase the point of shooter game status
   *
  ...
  public ShooterPointBuff(Context context) {
    ...
    setObject(Bitmap.createScaledBitmap(getObject(), 150, 150, false));
  }
  ...
  public static final Creator<ShooterPointBuff> CREATOR =
      new Creator<ShooterPointBuff>() {
        @Override
