...
public class ShooterPlaneExplosion extends ShooterExplosion implements Parcelable {
  ...
  public ShooterPlaneExplosion(Context context, int explosionX, int explosionY) {
    ...
    explosions[0] =
        BitmapFactory.decodeResource(context.getResources(), R.drawable.psplaneexplosion1);
    explosions[1] =
        BitmapFactory.decodeResource(context.getResources(), R.drawable.psplaneexplosion2);
    explosions[2] =
        BitmapFactory.decodeResource(context.getResources(), R.drawable.psplaneexplosion3);
    explosions[3] =
        BitmapFactory.decodeResource(context.getResources(), R.drawable.psplaneexplosion4);
    explosions[4] =
        BitmapFactory.decodeResource(context.getResources(), R.drawable.psplaneexplosion5);
    setWidthHeight();
  }
  ...
  public static final Creator<ShooterPlaneExplosion> CREATOR =
      new Creator<ShooterPlaneExplosion>() {
        @Override
