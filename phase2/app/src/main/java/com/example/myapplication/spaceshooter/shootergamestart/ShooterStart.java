...
public class ShooterStart extends AppCompatActivity
    implements View.OnClickListener, ShooterStartView {
  /** The Start button. */
  Button start,
      /** The Exit button. */
      exit,
  ...
  /** resume the gameStart activity make music start and check if resume button should appear. */
  @Override
