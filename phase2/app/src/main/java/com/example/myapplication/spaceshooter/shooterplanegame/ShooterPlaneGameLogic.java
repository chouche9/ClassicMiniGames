...
class ShooterPlaneGameLogic {
   ...
   */
  ShooterPlaneGameLogic(
      ShooterGameStatusFacade shooterGameStatus, Context context, ShooterGameView shooterGameView) {
  ...
  /**
   * Should music stop boolean. indicate whether music should stop
   *
   * @return the boolean
   */
