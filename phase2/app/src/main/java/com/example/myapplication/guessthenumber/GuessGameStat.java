package com.example.myapplication.guessthenumber;
...
public class GuessGameStat extends GameStatus implements Parcelable {
  ...
  /**
   * binary indicate whether player finish the last game or not. 0 represent finish, 1 represent not
   * finish
   */
  ...
  public static final Creator<GuessGameStat> CREATOR =
      new Creator<GuessGameStat>() {
        @Override
