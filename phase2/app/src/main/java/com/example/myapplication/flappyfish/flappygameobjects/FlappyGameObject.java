...
public abstract class FlappyGameObject implements Parcelable {
  ...
  /**
   * Velocity of this game object. Direction of the object is indicated with positive velocity
   * facing right and negative velocity facing left.
   */
  ...
  /**
   * Constructs a new game object at the specified x and y coordinate with the given velocity.
   *
   ...
   * not move out of the screen using canvasWidth, minY and maxY.
   */
  public abstract boolean update(
      FlappyGameStatusFacade gameStatus, int canvasWidth, int minY, int maxY);
