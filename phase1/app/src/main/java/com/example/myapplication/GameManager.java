...
public class GameManager {
  ...
  public GameManager(Activity activity, String name) {
    this.sharedPreferences =
        activity.getApplicationContext().getSharedPreferences(name, Context.MODE_PRIVATE);
  ...
  public GameStatus getGameStatus(String username) {
    ...
    Gson gson =
        new GsonBuilder().registerTypeAdapter(GameStatus.class, gameStatDeserializer).create();
